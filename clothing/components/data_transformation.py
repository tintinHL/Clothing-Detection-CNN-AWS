...
from clothing.ml.feature.clothing_detection import ClothingDetection
from clothing.constants import *
from clothing.utils.main_utils import save_object
from clothing.entity.config_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        ...
        try:
            ...
            train_dataset = ClothingDetection(root=self.data_transformation_config.ROOT_DIR,split=self.data_transformation_config.TRAIN_SPLIT, transforms=self.get_transforms(True))

            logging.info(f"Training dataset prepared")

            test_dataset = ClothingDetection(root=self.data_transformation_config.ROOT_DIR, split=self.data_transformation_config.TEST_SPLIT, transforms=self.get_transforms(False))
